...
/**
@file
Definition of the Amenities component of a Poi.

Copyright 2018-2020 by Garmin Ltd. or its subsidiaries.
*/

#ifndef ACDB_Amenities_hpp
#define ACDB_Amenities_hpp
...
class Amenities {
 public:
  // functions
  Amenities(std::string&& aTitle, std::vector<YesNoUnknownNearbyField>&& aYnubFields,
  ...
  bool operator==(const Amenities& aRhs) const;
...
};  // end of class Amenities

}  // end of namespace Presentation
}  // end of namespace Acdb

#endif  // end of ACDB_Amenities_hpp
