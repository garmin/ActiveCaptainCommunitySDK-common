...
/**
@file
Definition of the Services component of a Poi.

Copyright 2018-2020 by Garmin Ltd. or its subsidiaries.
*/

#ifndef ACDB_Services_hpp
#define ACDB_Services_hpp
...
class Services {
 public:
  // functions
  Services(std::string&& aTitle, std::vector<YesNoUnknownNearbyField>&& aYnubFields,
  ...
  bool operator==(const Services& aRhs) const;
...
#endif  // end of ACDB_Services_hpp
