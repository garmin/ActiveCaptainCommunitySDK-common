...
/**
@file
Definition of the Contact component of a Poi.

Copyright 2018-2020 by Garmin Ltd. or its subsidiaries.
*/

#ifndef ACDB_Contact_hpp
#define ACDB_Contact_hpp
...
class Contact {
 public:
  // functions
  Contact(std::string&& aTitle, std::vector<AttributeField>&& aAttributeFields,
          LinkField&& aEditField);

  bool operator==(const Contact& aRhs) const;
