...
void PopulateDatabase(TF_state_type* aState, SQLite::Database& aDatabase) {
  ...
  std::vector<MarkerTableDataType> markerTableData{
      ...
      MarkerTableDataType{11,
                          ...
                          minimalCategory,
                          ACDB_INVALID_BUSINESS_PROGRAM_TIER},
      MarkerTableDataType{12,
                          ACDB_ANCHORAGE,
                          1715841222,
                          "Test Anchorage 12",
                          {200, 200},
                          GetGeohashStart(12, 12),
                          minimalCategory,
                          ACDB_INVALID_BUSINESS_PROGRAM_TIER},
      MarkerTableDataType{13,
                          ACDB_ANCHORAGE,
                          1715841223,
                          "Test Anchorage 13",
                          {500, 500},
                          GetGeohashStart(13, 13),
                          minimalCategory,
                          ACDB_INVALID_BUSINESS_PROGRAM_TIER},
      MarkerTableDataType{14,
                          ACDB_BOAT_RAMP,
                          1715841298,
                          "Test Boat Ramp 14",
                          {200, 200},
                          GetGeohashStart(14, 14),
                          minimalCategory,
                          ACDB_INVALID_BUSINESS_PROGRAM_TIER},
      MarkerTableDataType{15,
                          ACDB_BUSINESS,
                          1715841302,
                          "Test Business 15",
                          {200, 200},
                          GetGeohashStart(15, 15),
                          minimalCategory,
                          ACDB_INVALID_BUSINESS_PROGRAM_TIER},
      MarkerTableDataType{16,
                          ACDB_INLET,
                          1715841303,
                          "Test Inlet 16",
                          {200, 200},
                          GetGeohashStart(16, 16),
                          minimalCategory,
                          ACDB_INVALID_BUSINESS_PROGRAM_TIER},
      MarkerTableDataType{17,
                          ACDB_BRIDGE,
                          1715841304,
                          "Test Bridge 17",
                          {200, 200},
                          GetGeohashStart(17, 17),
                          minimalCategory,
                          ACDB_INVALID_BUSINESS_PROGRAM_TIER},
      MarkerTableDataType{18,
                          ACDB_LOCK,
                          1715841305,
                          "Test Lock 18",
                          {200, 200},
                          GetGeohashStart(18, 18),
                          minimalCategory,
                          ACDB_INVALID_BUSINESS_PROGRAM_TIER},
      MarkerTableDataType{19,
                          ACDB_DAM,
                          1715841306,
                          "Test Dam 19",
                          {200, 200},
                          GetGeohashStart(19, 19),
                          minimalCategory,
                          ACDB_INVALID_BUSINESS_PROGRAM_TIER},
      MarkerTableDataType{20,
                          ACDB_FERRY,
                          1715841307,
                          "Test Ferry 20",
                          {200, 200},
                          GetGeohashStart(20, 20),
                          minimalCategory,
                          ACDB_INVALID_BUSINESS_PROGRAM_TIER},
      ...
      MarkerTableDataType{22,
                          ...
                          minimalCategory,
                          ACDB_INVALID_BUSINESS_PROGRAM_TIER},
      MarkerTableDataType{23,
                          ACDB_HAZARD,
                          1715842820,
                          "Test Hazard 23",
                          {500, 500},
                          GetGeohashStart(23, 23),
                          minimalCategory,
                          ACDB_INVALID_BUSINESS_PROGRAM_TIER},

      MarkerTableDataType{24,
                          ACDB_BOAT_RAMP,
                          1715841298,
                          "Test Boat Ramp 24",
                          {500, 500},
                          GetGeohashStart(24, 24),
                          minimalCategory,
                          ACDB_INVALID_BUSINESS_PROGRAM_TIER},
      MarkerTableDataType{25,
                          ACDB_BUSINESS,
                          1715841302,
                          "Test Business 25",
                          {500, 500},
                          GetGeohashStart(25, 25),
                          minimalCategory,
                          ACDB_INVALID_BUSINESS_PROGRAM_TIER},
      MarkerTableDataType{26,
                          ACDB_INLET,
                          1715841303,
                          "Test Inlet 26",
                          {500, 500},
                          GetGeohashStart(26, 26),
                          minimalCategory,
                          ACDB_INVALID_BUSINESS_PROGRAM_TIER},
      MarkerTableDataType{27,
                          ACDB_BRIDGE,
                          1715841304,
                          "Test Bridge 27",
                          {500, 500},
                          GetGeohashStart(27, 27),
                          minimalCategory,
                          ACDB_INVALID_BUSINESS_PROGRAM_TIER},
      MarkerTableDataType{28,
                          ACDB_LOCK,
                          1715841305,
                          "Test Lock 28",
                          {500, 500},
                          GetGeohashStart(28, 28),
                          minimalCategory,
                          ACDB_INVALID_BUSINESS_PROGRAM_TIER},
      MarkerTableDataType{29,
                          ACDB_DAM,
                          1715841306,
                          "Test Dam 29",
                          {500, 500},
                          GetGeohashStart(29, 29),
                          minimalCategory,
                          ACDB_INVALID_BUSINESS_PROGRAM_TIER},
      MarkerTableDataType{30,
                          ACDB_FERRY,
                          1715841307,
                          "Test Ferry 30",
                          {500, 500},
                          GetGeohashStart(30, 30),
                          minimalCategory,
                          ACDB_INVALID_BUSINESS_PROGRAM_TIER},
  };
  ...
  // Add a review for marker 23.
  TF_assert(aState,
            reviewQuery.Write(999, ReviewTableDataType{6, 2, 1715842821, 3, "Review Title 6",
                                                       "2024-05-16T00:00:00Z", "Test Captain 6",
                                                       "Review Text 6", 0, false, std::string()}));
  ...
  for (auto marker : markerTableData) {
    ...
    TF_assert(aState, positionQuery.Write(markerId, posn));
    TF_assert(aState, markerMetaQuery.Write(markerId, std::move(markerMetaTableData)));
  }
