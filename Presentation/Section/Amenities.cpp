...
Amenities object from the sqlite database

Copyright 2018-2020 by Garmin Ltd. or its subsidiaries.
*/

#define DBG_MODULE "ACDB"
#define DBG_TAG "Amenities"
...
//!
//----------------------------------------------------------------
Amenities::Amenities(std::string&& aTitle, std::vector<YesNoUnknownNearbyField>&& aYnubFields,
    ...
    : mTitle(std::move(aTitle)),
      ...
      mSeeAllField(std::move(aSeeAllField)) {}  // end of Amenities
...
//!
//----------------------------------------------------------------
bool Amenities::operator==(const Amenities& aRhs) const {
...
//!
//----------------------------------------------------------------
const std::vector<YesNoUnknownNearbyField>& Amenities::GetYesNoUnknownNearbyFields() const {
  return mYnubFields;
...
//!
//----------------------------------------------------------------
const std::vector<YesNoUnknownNearbyFieldPair>& Amenities::GetYesNoUnknownNearbyFieldPairs() const {
...
//!
//----------------------------------------------------------------
const LinkField& Amenities::GetEditField() const { return mEditField; }  // end of GetEditField
...
//!
//----------------------------------------------------------------
const AttributeField* Amenities::GetNote() const { return mNote.get(); }  // end of GetNote
...
//!
//----------------------------------------------------------------
const LinkField& Amenities::GetSeeAllField() const {
  return mSeeAllField;
...
//!
//----------------------------------------------------------------
const std::string& Amenities::GetTitle() const { return mTitle; }  // end of GetTitle
